...
public class BishopMovesTest {
    ...
    public void cantMoveBlockedPiecesSameSide() throws FenParserException {
        FenPositionGameHandler gameHandler = FenGameParser.parse("8/8/8/3P1P2/4B3/3P1P2/8/8 w", kingHandler, playerHandler, gamePropertiesHandler);
    ...
    public void cantKillKingButCheckTest() throws FenParserException {
        FenPositionGameHandler gameHandler = FenGameParser.parse("8/8/8/8/8/5k2/8/7B w", kingHandler, playerHandler, gamePropertiesHandler);
    ...
    public void cantKillKingButCheckMateTest() throws FenParserException {
        FenPositionGameHandler gameHandler = FenGameParser.parse("k7/8/3B4/3B4/3B4/8/8/8 w", kingHandler, playerHandler, gamePropertiesHandler);
    ...
    public void cantMoveBishopOrCheckMateTest() throws FenParserException {
        FenPositionGameHandler gameHandler = FenGameParser.parse("kb6/b7/2b5/8/4B3/8/8/8 w", kingHandler, playerHandler, gamePropertiesHandler);
